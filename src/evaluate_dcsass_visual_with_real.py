...
X_REAL_PATH = os.path.join(FEATURE_DIR, "real_dcsass_visual_features.npy")
Y_REAL_PATH = os.path.join(FEATURE_DIR, "real_dcsass_visual_labels.npy")
...
evaluate_classifier(
    ...
    input_name="real_data_evaluated_on_dcsass"  # 🏷️ custom tag
)
